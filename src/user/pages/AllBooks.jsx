  ...
  return (
    <div>
      <Header />
      {
        ...
        <section>
        <div className="">
          <div className="text-center text-3xl mt-5 mb-5">
            <h2>Collection</h2>
          </div>
      ...
      <div className="ml-10 mt-15 text-2xl">
       ...
       <div className='flex justify-center align-middle p-6'>
         <img src="https://e7.pngegg.com/pngimages/222/241/png-clipart-login-gif-logfile-computer-icons-burn-effect-computer-logo.png" alt="" />
         <p>Pleace <Link to={"/login"}>Login</Link>To Explore More</p>
       </div>
      }
